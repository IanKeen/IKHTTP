...
// IKCore
#define COCOAPODS_POD_AVAILABLE_IKCore
#define COCOAPODS_VERSION_MAJOR_IKCore 1
#define COCOAPODS_VERSION_MINOR_IKCore 2
#define COCOAPODS_VERSION_PATCH_IKCore 0

// IKEvents
#define COCOAPODS_POD_AVAILABLE_IKEvents
#define COCOAPODS_VERSION_MAJOR_IKEvents 1
#define COCOAPODS_VERSION_MINOR_IKEvents 0
#define COCOAPODS_VERSION_PATCH_IKEvents 1

// IKResults
#define COCOAPODS_POD_AVAILABLE_IKResults
#define COCOAPODS_VERSION_MAJOR_IKResults 1
#define COCOAPODS_VERSION_MINOR_IKResults 1
#define COCOAPODS_VERSION_PATCH_IKResults 0
